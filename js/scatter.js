...
function scatterVersicolor(svg_name, data, x_field, y_field) {
    var svg = d3.select(svg_name);
    svg.selectAll("*").remove();
    ...
    for (const index of data) {
        if (index["Species"] == "Iris-versicolor") {
            newData.push(index);
        }
    }
...
function scatterVirginica(svg_name, data, x_field, y_field) {
    var svg = d3.select(svg_name);
    svg.selectAll("*").remove();
    ...
    let i = 0;
    for (const index of data) {
        if (index["Species"] == "Iris-virginica") {
            newData.push(index);
        }
    }
    ...
    // Add Legend
    g.append("circle").attr("cx", 700).attr("cy", -30).attr("r", 5).style("fill", "green")
    g.append("text").attr("x", 710).attr("y", -30).text("Iris-virginica").style("font-size", "15px").attr("alignment-baseline", "middle")
...
function scatterSetosa(svg_name, data, x_field, y_field) {
    ...
    // Add Legend
    g.append("circle").attr("cx", 700).attr("cy", -30).attr("r", 5).style("fill", "red")
    g.append("text").attr("x", 710).attr("y", -30).text("Iris-setosa").style("font-size", "15px").attr("alignment-baseline", "middle")
...
function malePlot(svg_name, data, x_field, y_field) {
    var svg = d3.select(svg_name);
    svg.selectAll("*").remove();
...
function femalePlot(svg_name, data, x_field, y_field) {
    var svg = d3.select(svg_name);
    svg.selectAll("*").remove();
    ...
    // Add Legend
    g.append("circle").attr("cx", 700).attr("cy", -30).attr("r", 5).style("fill", "pink")
    g.append("text").attr("x", 710).attr("y", -30).text("Female").style("font-size", "15px").attr("alignment-baseline", "middle")
